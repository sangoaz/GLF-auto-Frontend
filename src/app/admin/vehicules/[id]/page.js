    ...
    try {
      const res = await fetch(`http://127.0.0.1:8000/admin/vehicles/${id}`, {
        ...
        body: JSON.stringify({
          ...
          year: parseInt(vehicule.year),
          mileage: parseInt(vehicule.mileage),
          price: parseInt(vehicule.price),
          fuel: vehicule.fuel,
          transmission: vehicule.transmission,
          status: vehicule.status,
          description: vehicule.description,
          is_published: vehicule.is_published,
          is_featured: vehicule.is_featured,
        }),
      })
          ...
          <div className="lg:col-span-2">
            ...
            <form onSubmit={handleSave} className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                ...
                <input name="title" type="text" required value={vehicule.title} onChange={handleChange}
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input name="brand" type="text" required value={vehicule.brand} onChange={handleChange}
                    className="px-4 py-3 text-sm outline-none" style={inputStyle} />
                </div>
                <div className="flex flex-col gap-2">
                  <label className={labelClass} style={{ color: 'var(--color-text-muted)' }}>Modèle *</label>
                  <input name="model" type="text" required value={vehicule.model} onChange={handleChange}
                    className="px-4 py-3 text-sm outline-none" style={inputStyle} />
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input name="year" type="number" required value={vehicule.year} onChange={handleChange}
                    className="px-4 py-3 text-sm outline-none" style={inputStyle} />
                </div>
                <div className="flex flex-col gap-2">
                  <label className={labelClass} style={{ color: 'var(--color-text-muted)' }}>Kilométrage *</label>
                  <input name="mileage" type="number" required value={vehicule.mileage} onChange={handleChange}
                    className="px-4 py-3 text-sm outline-none" style={inputStyle} />
                </div>
                <div className="flex flex-col gap-2">
                  <label className={labelClass} style={{ color: 'var(--color-text-muted)' }}>Prix (€) *</label>
                  <input name="price" type="number" required value={vehicule.price} onChange={handleChange}
                    className="px-4 py-3 text-sm outline-none" style={inputStyle} />
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <select name="fuel" value={vehicule.fuel} onChange={handleChange}
                    className="px-4 py-3 text-sm outline-none" style={inputStyle}>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select name="transmission" value={vehicule.transmission} onChange={handleChange}
                    className="px-4 py-3 text-sm outline-none" style={inputStyle}>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select name="status" value={vehicule.status} onChange={handleChange}
                    className="px-4 py-3 text-sm outline-none" style={inputStyle}>
              ...
              <div className="flex gap-6">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" checked={vehicule.is_published}
                    onChange={e => setVehicule({ ...vehicule, is_published: e.target.checked })} />
                  <span className="text-sm font-bold" style={{ color: 'var(--color-text)' }}>Publié</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" checked={vehicule.is_featured}
                    onChange={e => setVehicule({ ...vehicule, is_featured: e.target.checked })} />
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea name="description" required rows={5} value={vehicule.description} onChange={handleChange}
