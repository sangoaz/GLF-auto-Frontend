    ...
    async function fetchStats() {
      try {
        const [vehicules, pieces, contacts, reprises] = await Promise.all([
          fetch("http://127.0.0.1:8000/admin/vehicles?limit=1", { headers: authHeaders() }),
          fetch("http://127.0.0.1:8000/admin/parts?limit=1", { headers: authHeaders() }),
          fetch("http://127.0.0.1:8000/admin/contact-requests?limit=5", { headers: authHeaders() }),
          fetch("http://127.0.0.1:8000/admin/trade-in-requests?limit=5", { headers: authHeaders() }),
        ])
